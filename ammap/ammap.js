    ...
    d.callInitHandler = function(a) {
        ...
        if (d.initHandlers)
            for (var c = 0; c < b.length; c++) {
                var e = b[c];
                e.types ? d.isInArray(e.types, a.type) && e.method(a) :
                    e.method(a)
            }
    };
...
(function() {
    ...
    d.AmChart = d.Class({
        ...
        measure: function() {
            ...
            if (a) {
                var b = this.chartDiv,
                    ...
                    e = a.offsetHeight,
                    f = this.container,
                    c = d.removePx(d.getStyle(a, "padding-left")),
                    e = d.removePx(d.getStyle(a, "padding-right")),
                    g = d.removePx(d.getStyle(a, "padding-top")),
                    h = d.removePx(d.getStyle(a, "padding-bottom"));
                isNaN(c);
                isNaN(e);
                isNaN(g);
                isNaN(h);
                ...
                (c != this.previousWidth || e != this.previousHeight) && 0 < a && 0 < g && (b.style.width =
                    a + "px", b.style.height = g + "px", b.style.padding = 0, f && f.setSize(a, g), this.balloon = d.processObject(this.balloon, d.AmBalloon, this.theme));
                this.balloon.setBounds && this.balloon.setBounds(2, 2, a - 2, g);
                this.balloon.chart = this;
                this.realWidth = a;
                this.realHeight = g;
                this.divRealWidth = c;
        ...
        checkDisplay: function() {
            if (this.autoDisplay && this.container) {
                var a = d.rect(this.container, 10, 10),
                    b = a.getBBox();
                0 === b.width && 0 === b.height && (this.divRealHeight = this.divRealWidth = this.realHeight = this.realWidth = 0, this.previousWidth =
        ...
        clear: function(a) {
            ...
            this.chartCursor = this.scrollbarH = this.scrollbarV =
        ...
        handleDocTouchEnd: function() {
            -.5 < this.tmx && this.tmx < this.divRealWidth + 1 && 0 < this.tmy &&
        ...
        validateSize: function() {
            ...
            if (a.divRealWidth != a.previousWidth ||
        ...
        showBalloonReal: function(a, b, c, e, d) {
            this.handleMouseMove();
            var g = this.balloon;
            g.enabled && (g.followCursor(!1), g.changeColor(b), !c || g.fixedPosition ? (g.setPosition(e, d), isNaN(e) || isNaN(d) ? g.followCursor(!0) : g.followCursor(!1)) : g.followCursor(!0),
                a && g.showBalloon(a))
        },
        ...
        handleMouseMove: function(a) {
            ...
            if (a) {
                if (a.touches) {
                    ...
                    g && this.panEventsEnabled && this.boundingRect &&
                        (e = g.clientX - this.boundingRect.left, d = g.clientY - this.boundingRect.top);
                    a = a.touches.item(0);
                    if (!a) return
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    "H" != u ? (y = a - z / 2, b < k + w + 10 && "down" != u ? (H = !0, e && (b += A), A = b + B, this.deltaSignY = -1) : (e && (b -= A), A = b - w - B, this.deltaSignY = 1)) : (2 * B > w && (B = w / 2), A = b - w / 2, a < h + (l - h) / 2 ? (y = a + B, this.deltaSignX = -1) : (y = a - z - B, this.deltaSignX = 1));
                    A + w >= m && (A = m - w);
                    A < k && (A = k);
                    y < h && (y = h);
                    y + z > l && (y = l - z);
                    var k = A + v,
                        ...
                        J, v = this.fillAlpha,
                        L = this.borderAlpha;
                    this.showBullet && (J = d.circle(f, K, t, v), g.push(J));
                    this.drop ? (h = z / 1.6, l = 0, "V" == u && (u = "down"), "H" == u && (u = "left"), "down" == u && (y = a + 1, A = b - h - h / 3), "up" == u && (l = 180, y = a + 1, A = b + h + h / 3), "left" == u && (l = 270, y = a + h + h / 3 + 2, A = b), "right" == u && (l = 90, y = a - h - h / 3 + 2, A = b), k = A - E / 2 + 1, m = y - F / 2 - 1, q = d.drop(f, h, l, q, v, p, r, L)) : 0 < x || 0 === B ? (0 < G && (a = d.rect(f, z, w, q, 0, p + 1, D,
                        G, x), d.isModern ? a.translate(1, 1) : a.translate(4, 4), g.push(a)), q = d.rect(f, z, w, q, v, p, r, L, x)) : (t = [], x = [], "H" != u ? (h = a - y, h > z - B && (h = z - B), h < B && (h = B), t = [0, h - B, a - y, h + B, z, z, 0, 0], x = H ? [0, 0, b - A, 0, 0, w, w, 0] : [w, w, b - A, w, w, 0, 0, w]) : (u = b - A, u > w - B && (u = w - B), u < B && (u = B), x = [0, u - B, b - A, u + B, w, w, 0, 0], t = a < h + (l - h) / 2 ? [0, 0, y < a ? 0 : a - y, 0, 0, z, z, 0] : [z, z, y + z > a ? z : a - y, z, z, 0, 0, z]), 0 < G && (a = d.polygon(f, t, x, q, 0, p, D, G), a.translate(1, 1), g.push(a)), q = d.polygon(f, t, x, q, v, p, r, L));
                    this.bg = q;
                    g.push(q);
                    q.toFront();
                    ...
                    C.left = m + "px";
                    C.top = k + "px";
                    g.translate(y - f, A, 1, !0);
                    q = q.getBBox();
                    this.bottom = A + w + 1;
                    this.yPos = q.y + A;
                    J && J.translate(this.pointToX - y + f, b - A);
...
(function() {
    ...
    d.polygon = function(a, b, c, e, f, g, h, k, l, m, n) {
        ...
        k = "M" + (h(b[0]) + n) + "," + (h(c[0]) + g);
        for (var t = 1; t < b.length; t++) m && (b[t] = d.roundTo(b[t], 5), c[t] = d.roundTo(c[t], 5)), k += " L" + (h(b[t]) + n) + "," + (h(c[t]) + g);
        a = a.path(k + " Z").attr(f);
    ...
    d.rect = function(a, b, c, e, f, g, h, k, l, m, n) {
        ...
        void 0 !== n && 0 < n && (f["stroke-dasharray"] = n);
        a = a.rect(t, p, b, c, l, g).attr(f);
        r && a.gradient("linearGradient", e, m);
        return a
    };
    d.bullet = function(a, b, c, e, f, g, h, k, l, m, n, q, r) {
        var t;
        "circle" == b && (b = "round");
        switch (b) {
            case "round":
            ...
            case "square":
                t = d.polygon(a, [-c /
                    2, c / 2, c / 2, -c / 2
                ], [c / 2, c / 2, -c / 2, -c / 2], e, f, g, h, k, m - 180, void 0, r);
                break;
            case "rectangle":
            ...
            case "triangleRight":
                ...
                break;
            case "bubble":
                t = d.circle(a, c / 2, e, f,
                    g, h, k, !0);
                break;
            case "line":
                t = d.line(a, [-c / 2, c / 2], [0, 0], e, f, g, h, k);
                break;
            case "yError":
                t = a.set();
    ...
    d.handDrawnLine = function(a, b, c, e, f, g, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var r = [b[n - 1], b[n]], t = [c[n - 1], c[n]], t = d.makeHD(r, t, a.handDrawScatter), r = t[0], t = t[1], p = 1; p < r.length; p++) q.push(d.line(a, [r[p - 1], r[p]], [t[p - 1], t[p]], e, f, g + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return q
    };
    d.doNothing =
        function(a) {
    ...
    d.drop = function(a, b, c, e, d, g, h, k) {
        ...
        b = "M" + n + "," + q + " A" + b + "," + b + ",0,1,1," + r + "," + t + (" A" + p + "," + p + ",0,0,0," + (Math.sin((m + 20) * l) * b + B) + "," + (Math.cos((m + 20) * l) * b + v));
        b += " A" + p + "," + p + ",0,0,0," + n + "," + q;
        return a.path(b, void 0,
            void 0, "1000,1000").attr(c)
    };
    d.wedge = function(a, b, c, e, f, g, h, k, l, m, n, q, r, t) {
        var p = Math.round;
        g = p(g);
        h = p(h);
        k = p(k);
        ...
        var x = 1 / 180 * Math.PI,
            ...
            A = b + Math.sin(e * x) * g,
            C = c - Math.cos(e * x) * h,
            y = b + Math.sin((e + f) * x) * g,
            z = c - Math.cos((e + f) * x) * h,
            F = b + Math.sin((e + f) * x) * k,
            x = c - Math.cos((e + f) * x) * v,
            E = {
        ...
        e = a.set();
        var G;
        B && (u = p(10 * u), A = p(10 * A), y = p(10 * y), F = p(10 * F), w = p(10 * w), C = p(10 * C), z = p(10 * z), x = p(10 * x), b = p(10 * b), l = p(10 * l), c = p(10 * c), g *= 10, h *= 10, k *= 10, v *= 10, 1 > Math.abs(f) && 1 >= Math.abs(y - A) && 1 >= Math.abs(z - C) && (G = !0));
        f = "";
        var D;
        q && (E["fill-opacity"] = 0, E["stroke-opacity"] = m["stroke-opacity"] / 2, E.stroke = m.stroke);
        if (0 < l) {
            D = " M" + u + "," + (w + l) + " L" + A + "," + (C + l);
            B ? (G || (D += " A" + (b - g) + "," + (l + c - h) + "," + (b + g) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + y + "," + (z + l)), D += " L" + F + "," + (x + l), 0 < k && (G || (D += " B" + (b - k) + "," + (l + c - v) + "," + (b + k) + "," +
                (l + c + v) + "," + F + "," + (l + x) + "," + u + "," + (l + w)))) : (D += " A" + g + "," + h + ",0," + H + ",1," + y + "," + (z + l) + " L" + F + "," + (x + l), 0 < k && (D += " A" + k + "," + v + ",0," + H + ",0," + u + "," + (w + l)));
            D += " Z";
            var K = l;
            B && (K /= 10);
            ...
            D = a.path(" M" + u + "," + w + " L" + u + "," + (w + l) + " L" + A + "," + (C + l) + " L" + A + "," + C + " L" + u + "," + w + " Z", void 0, void 0, "1000,1000").attr(E);
            l = a.path(" M" + y + "," + z + " L" + y + "," + (z + l) + " L" + F + "," + (x + l) + " L" + F + "," + x + " L" + y + "," + z + " Z", void 0, void 0,
                "1000,1000").attr(E);
            e.push(D);
            e.push(l)
        }
        B ? (G || (f = " A" + p(b - g) + "," + p(c - h) + "," + p(b + g) + "," + p(c + h) + "," + p(A) + "," + p(C) + "," + p(y) + "," + p(z)), h = " M" + p(u) + "," + p(w) + " L" + p(A) + "," + p(C) + f + " L" + p(F) + "," + p(x)) : h = " M" + u + "," + w + " L" + A + "," + C + (" A" + g + "," + h + ",0," + H + ",1," + y + "," + z) + " L" + F + "," + x;
        0 < k && (B ? G || (h += " B" + (b - k) + "," + (c - v) + "," + (b + k) + "," + (c + v) + "," + F + "," + x + "," + u + "," + w) : h += " A" + k + "," + v + ",0," + H + ",0," + u + "," + w);
        a.handDrawn && (k = d.line(a, [u, A], [w, C], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]),
            e.push(k));
        a = a.path(h + " Z", void 0, void 0, "1000,1000").attr(m);
        if (n) {
            k = [];
            for (v = 0; v < n.length; v++) k.push(d.adjustLuminosity(m.fill, n[v]));
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (w = 0; w < u.length; w++) {
                var F = u[w];
                this.reversedOrder && (F = u[u.length - w - 1]);
                x = F.getBBox();
                var E;
                this.equalWidths ? E = A * (r + n + this.markerLabelGap) : (E = C, C = C + x.width + g + n);
                x.height > z && (z = x.height);
                E + x.width > q && 0 < w && 0 !== A && (t++, E = A = 0, C = E + x.width + g + n, y = y + z + m, z = 0);
                F.translate(E, y);
                A++;
                !isNaN(l) && A >= l && (A = 0, t++, y = y + z + m, C = g, z = 0);
                B.push(F)
            }
            x = B.getBBox();
            l = x.height + 2 * m - 1;
            "left" == a || "right" == a ? (n = x.width + 2 * g, k = n + b + c, h.style.width = k + "px", this.ieW = k) : n = k - b - c - 1;
            ...
            c.toBack();
            b = g;
            if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a) "center" == this.align ? b = g + (n - x.width) / 2 : "right" == this.align && (b = g + n - x.width);
            B.translate(b, m + 1);
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) l = n.set(), a.hidden || (g = a.lineColorR, k = a.bulletBorderColorR), r = d.line(n, [0, 2 * q], [q / 2, q / 2], g, a.lineAlpha,
                        a.lineThickness, a.dashLength), d.setCN(c, r, "graph-stroke"), l.push(r), a.bullet && (a.hidden || (g = a.bulletColorR), r = d.bullet(n, a.bullet, a.bulletSize, g, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, r, "graph-bullet"), r.translate(q + 1, q / 2), l.push(r)), p = 0, r = q, t = q / 3;
                    else {
                        var v;
                        a.getGradRotation && (v = a.getGradRotation(), 0 === v && (v = 180));
                        r = a.fillColorsR;
                        !0 === a.hidden && (r = g);
                        if (l = b.createMarker("rectangle", r, a.fillAlphas, a.lineThickness, g, a.lineAlpha, v, l, a.dashLength)) p = q, l.translate(p,
                            q / 2);
                        r = q
                    }
                    d.setCN(c, l, "graph-" + e);
                    d.setCN(c, l, "graph-" + a.id)
                } else if (m) l = n.image(m, 0, 0, q, q);
                else {
                    var B;
                    isNaN(b.gradientRotation) || (B = 180 + b.gradientRotation);
                    (l = b.createMarker(f, g, h, void 0, void 0, void 0, B, l)) && l.translate(q / 2, q / 2)
                }
                d.setCN(c, l, "legend-marker");
                b.addListeners(l, a);
                n = n.set([l]);
                b.switchable && a.switchable && n.setAttr("cursor", "pointer");
                void 0 !== a.id && d.setCN(c, n, "legend-item-" + a.id);
                d.setCN(c, n, a.className, !0);
                k = b.switchType;
                var u;
                k && "none" != k && 0 < q && ("x" == k ? (u = b.createX(), u.translate(q /
                    2, q / 2)) : u = b.createV(), u.dItem = a, !0 !== a.hidden ? "x" == k ? u.hide() : u.show() : "x" != k && u.hide(), b.switchable || u.hide(), b.addListeners(u, a), a.legendSwitch = u, n.push(u), d.setCN(c, u, "legend-switch"));
                k = b.color;
                a.showBalloon && b.textClickEnabled && void 0 !== b.selectedColor && (k = b.selectedColor);
                b.useMarkerColorForLabels && (k = g);
                !0 === a.hidden && (k = b.markerDisabledColor);
                g = d.massReplace(b.labelText, {
                    "[[title]]": a.title
                });
                void 0 !== b.tabIndex && (n.setAttr("tabindex", b.tabIndex), n.setAttr("role", "menuitem"), n.keyup(function(c) {
                    13 ==
                        c.keyCode && b.clickMarker(a, c)
                }));
                c.accessible && b.accessibleLabel && (v = d.massReplace(b.accessibleLabel, {
                    "[[title]]": a.title
                }), c.makeAccessible(n, v));
                v = b.fontSize;
                l && (q <= v && (q = q / 2 + b.ly - v / 2 + (v + 2 - q) / 2 - t, l.translate(p, q), u && u.translate(u.x, q)), a.legendEntryWidth = l.getBBox().width);
                var x;
                g && (g = d.fixBrakes(g), a.legendTextReal = g, x = b.labelWidth, x = isNaN(x) ? d.text(b.container, g, k, c.fontFamily, v, "start") : d.wrappedText(b.container, g, k, c.fontFamily, v, "start", !1, x, 0), d.setCN(c, x, "legend-label"), x.translate(b.lx +
                    r, b.ly), n.push(x), b.labelDx = r, c = x.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
                b.entries[b.index] = n;
            ...
            if (a)
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e) g.value ? f.text(g.value) : f.text("");
                        ...
                        g.legendColorFunction && (n = g.legendColorFunction(l,
...
(function() {
    ...
    d.AmMap = d.Class({
        ...
        initChart: function() {
            ...
            } else(d.AmMap.base.initChart.call(this), d.hasSVG) ? (this.dataChanged && (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged = !1, a = this.legend) && (a.position = "absolute", a.invalidateSize()), this.createDescriptionsDiv(), this.svgAreas = [], this.svgAreasById = {}, this.drawChart()) : (this.chartDiv.style.textAlign =
        ...
        makeObjectAccessible: function(a) {
            if (a.accessibleLabel) {
                var b =
                    this.formatString(a.accessibleLabel, a);
        ...
        rescaleObjects: function() {
            ...
            for (c = 0; c < b.length; c++) {
                var e = b[c].image,
                    d = b[c].scale,
                    g = b[c].mapImage;
                isNaN(g.selectedScaleReal) || g != this.selectedObject || (g.tempScale = d, d *= g.selectedScaleReal);
            ...
            if (e = b.linesToResize)
                for (c =
                    0; c < e.length; c++) d = e[c], d.line.setAttr("stroke-width", d.thickness / a);
            b = b.objectsToResize;
        ...
        handleMouseDown: function(a) {
            ...
            if (this.chartCreated && !this.preventHover &&
                (this.initialTouchZoom = this.zoomLevel(), this.dragMap && (this.stopAnimation(), this.mapContainerClickX = this.mapContainer.x, this.mapContainerClickY = this.mapContainer.y), a || (a = window.event), a.shiftKey && !0 === this.developerMode && this.getDevInfo(), a && a.touches)) {
                var b = this.mouseX,
                    c = this.mouseY,
                    e = a.touches.item(1);
        ...
        handleReleaseOutside: function() {
            if (d.isModern) {
                ...
                if (!a.preventHover) {
                    ...
                    isNaN(c) || isNaN(e) || !(3 < Math.abs(b.x - c) || 3 < Math.abs(b.y - e)) ||
                        (a.mapWasDragged = !0, b = {
                            type: "dragCompleted",
                            zoomX: a.zoomX(),
                            zoomY: a.zoomY(),
                    ...
                    a.zoomOnDoubleClick && a.mouseIsOver && (b = (new Date).getTime(), 200 > b - a.previousClickTime && 40 < b - a.previousClickTime && a.doDoubleClickZoom(), a.previousClickTime =
                        b)
                }
                a.wasTouched = !1
            }
                ...
                if (a = b.mapContainer) {
                    ...
                    if (!isNaN(k)) {
                        ...
                        var t = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)),
                            p = b.initialDistance;
                        isNaN(p) && (p = Math.sqrt(Math.pow(k - f, 2) +
                            Math.pow(l - g, 2)));
                        if (!isNaN(p)) {
                            var k = b.initialTouchZoom * t / p,
                                ...
                                t = m / r,
                                v = n / q,
                                p = (b.zoomX() - p * v) * (k / h) + p * v,
                                l = (b.zoomY() - l * t) * (k / h) + l * t;
                            .1 < Math.abs(k - h) && (b.zoomTo(k, p, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    k = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (f - c), e = a.y + (g - e), b.preventDragOut && (r = -r * k + m / 2, m /= 2, c = d.fitToBounds(c, -q * k + n / 2, n / 2), e = d.fitToBounds(e, r, m)), isNaN(c) || isNaN(e) ||
        ...
        selectObject: function(a, b) {
            ...
            var g = !1,
                h, k;
            "MapArea" == a.objectType && (a.autoZoomReal && (g = !0), h = c.areasSettings.selectedOutlineColor,
            ...
            if (e) {
                if (d.removeCN(c,
                        e, "selected-object"), d.setCN(c, e, "selected-object"), a.bringForwardOnHover && a.displayObject.toFront(), c.outlinesToFront(), !a.preserveOriginalAttributes) {
            ...
            if (e = a.groupId)
                for (l = a.groupArray, l || (l = c.getGroupById(e), a.groupArray = l), m = 0; m < l.length; m++)
                    if (n = l[m], n.isOver = !1, e = n.displayObject, "MapImage" == n.objectType && (e = n.image), e) {
                        ...
                        void 0 !== h && e.setAttr("stroke", h);
                        void 0 !== k && e.setAttr("stroke-width", k);
                        "MapLine" == n.objectType && ((e = n.lineSvg) && e.setAttr("stroke", g), e = n.arrowSvg) && (e.setAttr("fill",
                            g), e.setAttr("stroke", g))
                    }
            c.rescaleObjects();
        ...
        outlinesToFront: function() {
            if (this.outlines)
                for (var a =
                        0; a < this.outlines.length; a++) this.outlines[a].toFront()
        },
        ...
        returnInitialColorReal: function(a) {
            ...
            if (b) {
                ...
                (b = a.imageLabel) && !a.labelInactive &&
                    (a.showAsSelected && void 0 !== a.selectedLabelColor ? b.setAttr("fill", a.selectedLabelColor) : b.setAttr("fill", a.labelColorReal))
            }
        },
        ...
        zoomToStageXY: function(a, b, c, e) {
            if (!this.objectWasClicked) {
                ...
                b = this.xyToCoordinates((b -
                    this.mapContainer.x) / f - g.x * this.mapScale, (c - this.mapContainer.y) / f - g.y * this.mapScale);
        ...
        zoomToObject: function(a) {
            if (a) {
                ...
                "MapArea" == a.objectType && (f = a.displayObject.getBBox(), g = this.mapScale, b = (f.x + this.diffX) *
                    g, c = (f.y + this.diffY) * g, e = f.width * g, f = f.height * g, k = a.autoZoomReal && isNaN(a.zoomLevel) ? e / k > f / l ? .8 * k / e : .8 * l / f : a.zoomLevel, l = this.zoomControl, k = d.fitToBounds(k, l.minZoomLevel, l.maxZoomLevel), isNaN(a.zoomX) && isNaN(a.zoomY) && isNaN(a.zoomLatitude) && isNaN(a.zoomLongitude) && this.zoomToMapXY(k, b + e / 2, c + f / 2));
        ...
        showAsRolledOver: function(a) {
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                if (void 0 != c)
                    if ("MapImage" == a.objectType)(e = a.image) &&
                        e.setAttr("fill", c);
                ...
                "MapImage" == a.objectType ? (c = this.imagesSettings.rollOverOutlineThickness, (e = a.image) && (isNaN(c) || e.setAttr("stroke-width",
                    c))) : (c = this.areasSettings.rollOverOutlineThickness, isNaN(c) || b.setAttr("stroke-width", c));
                ...
                "MapImage" == a.objectType &&
                    (c = a.rollOverScaleReal, isNaN(c) || 1 == c || (e = b.scale, isNaN(e) && (e = 1), a.tempScale = e, b.translate(b.x, b.y, e * c, !0)));
        ...
        rollOverMapObject: function(a, b, c) {
            if (this.chartCreated) {
                ...
                d && d != a ? (!1 === this.checkIfSelected(d) && (this.returnInitialColor(d, !0), this.previouslyHovered = null), this.balloon.hide(0)) :
                ...
                if (!this.preventHover) {
                    ...
                    this.showDescriptionOnHover ? this.showDescription(a) : !this.showBalloonOnSelectedObject && this.checkIfSelected(a) || !1 === b || (f = this.balloon, this.balloon.fixedPosition = !1, b =
                        a.colorReal, d = "", void 0 !== b && this.useObjectColorForBalloon || (b = f.fillColor), (f = a.balloonTextReal) && (d = this.formatString(f, a)), this.balloonLabelFunction && (d = this.balloonLabelFunction(a, this)), d && "" !== d && this.showBalloon(d, b, !1, this.balloonX, this.balloonY));
                    this.fire({
        ...
        latitudeToY: function(a) {
            return (this.latitudeToCoordinate(a) +
                this.diffY * this.mapScale) * this.zoomLevel() + this.mapContainer.y
        },
        ...
        showBalloonAfterZoom: function() {
            ...
            "MapImage" != c.objectType || isNaN(c.longitude) ||
            ...
            if (a) {
                ...
                if (b) d.getURL(b, a.urlTarget);
                    ...
                    b && a.passZoomValuesToTarget && (b.zoomLatitude = this.zoomLatitude(),
                        b.zoomLongitude = this.zoomLongitude(), b.zoomLevel = this.zoomLevel());
        ...
        showDescription: function(a) {
            ...
            if (a.description) {
                ...
                b.show(this, this.descriptionsDiv, a.description,
                    l);
                a = b.div.style;
                a.position = "absolute";
                a.width = c + "px";
        ...
        zoomLatitude: function() {
            if (this.mapContainer) {
                var a = this.mapSet.getBBox(),
                    b = (-this.mapContainer.x + this.previousWidth /
                        2) / this.zoomLevel() - a.x * this.mapScale,
            ...
            if (c) {
                ...
                for (f = 0; f < k; f++) {
                    ...
                    if (0 !== g.childNodes.length || "" !== m || !1 !== n)
                        ...
                        var q;
                        void 0 !== a[b][l] ? void 0 === a[b][l].length ? (q = a[b][l], a[b][l] = [], a[b][l].push(q), a[b][l].push({}), q = a[b][l][1]) : "object" == typeof a[b][l] && (a[b][l].push({}), q = a[b][l][a[b][l].length -
                            1
                        ]) : (a[b][l] = {}, q = a[b][l]);
                        if (g.attributes && g.attributes.length)
                            for (m = 0; m < g.attributes.length; m++) q[g.attributes[m].name] = g.attributes[m].value;
        ...
        getDevInfo: function() {
            var a =
                ...
                a = {
                    ...
                    percentLeft: Math.round(this.mouseX /
                        this.realWidth * 100) + "%",
        ...
        redrawArea: function(a) {
            for (var b = !1, c = "", e = 0; e < a.length; e++) {
                var f = a[e][0],
                    ...
                    h = d.roundTo(this.x2c(d.radiansToDegrees(k[0])),
                        3),
        ...
        normalizeMap: function() {
            var a = d.degreesToRadians(this.dataProvider.leftLongitude),
                b =
                d.degreesToRadians(this.dataProvider.rightLongitude),
        ...
        fixMapPosition: function() {
            ...
            a =
                this.coordinatesToXY(d.radiansToDegrees(a), d.radiansToDegrees(g));
            c = g = Infinity;
        ...
        coordinatesToXY: function(a, b) {
            ...
            this.projectionFunction && !c ? (e = this.projectionFunction(d.degreesToRadians(a), d.degreesToRadians(b)), c = this.mapScale * d.roundTo(this.x2c(d.radiansToDegrees(e[0])), 3), e = this.mapScale * d.roundTo(this.y2c(d.radiansToDegrees(e[1])), 3)) : (c = this.longitudeToCoordinate(a), e = this.latitudeToCoordinate(b));
            return {
                x: c,
                y: e
            }
        ...
        xyToCoordinates: function(a, b, c, e, f) {
            ...
            if (g = c.invert) {
                var h = this.dataProvider.leftLongitude,
                    ...
                    h = d.radiansToDegrees(c(d.degreesToRadians(h), d.degreesToRadians(q))[0]),
                    k = d.radiansToDegrees(c(d.degreesToRadians(k), d.degreesToRadians(q))[0]);
                this.projectionChanged && (l = d.radiansToDegrees(c(d.degreesToRadians(this.topLongLat.longitude),
        ...
        coordinateToLatitude: function(a, b) {
            ...
            if (this.mapSet) {
                var e = this.dataProvider,
                    f = e.bottomLatitude;
                c = e.topLatitude;
                "mercator" == e.projection ? (e = this.mercatorLatitudeToCoordinate(f), c = this.mercatorLatitudeToCoordinate(c), c = 2 * d.degreesToRadians(a * (e - c) / b + c), c = d.radiansToDegrees(2 * Math.atan(Math.exp(c)) - .5 * Math.PI)) : c =
                    a / b * (f - c) + c
            }
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            var f = c.buttonSize,
                ...
                y = a.getX(c.left),
                z = a.getY(c.top);
            isNaN(c.right) || (y = a.getX(c.right, !0), y = h ? y - 3 * f : y - f);
            isNaN(c.bottom) || (z = a.getY(c.bottom, !0), g && (z -= p + 3 * f), z = h ? z - 3 * f : c.homeButtonEnabled ? z - .5 * f : z + f);
            e.translate(y, z);
            c.previousDY = NaN;
            var F, y = f / 4 - 1;
            if (g) {
                ...
                c.set = e;
                c.zoomSet = F;
                5 < p && (g = d.rect(b, f + 6, p + 2 * f + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, "#000000", 0, 4), d.setCN(a, g, "zoom-bg"), g.translate(-3, -3), g.mouseup(function() {
                    c.handleBgUp()
                }).touchend(function() {
                    c.handleBgUp()
                }), F.push(g));
                ...
                A && (E = f / 1.5);
                c.draggerSize = E;
                var H = Math.log(u / B) / Math.log(v) + 1;
                1E3 < H && (H = 1E3);
                var g = p / H,
                    G, D = b.set();
                ...
                c.previousY = NaN;
                z = new d.SimpleButton;
                C ? (E = b.set(), H = d.line(b, [-y, y], [0, 0], w, x, 1), G = d.line(b, [0, 0], [-y, y], w, x, 1), E.push(H), E.push(G), z.svgIcon = E) : z.setIcon(a.pathToImages + "plus.gif", c.iconSize);
                z.setClickHandler(a.zoomIn, a);
                z.init(b, f, f, k, l, m, n, q, r, t, x, w, A);
                d.setCN(a, z.set, "zoom-in");
                F.push(z.set);
                z = new d.SimpleButton;
                C ? z.svgIcon = d.line(b, [-y, y], [0, 0], w, x, 1) : z.setIcon(a.pathToImages + "minus.gif", c.iconSize);
                z.setClickHandler(a.zoomOut, a);
                z.init(b, f, f, k, l, m, n, q, r, t, x, w, A);
                z.set.translate(0, p + f);
                d.setCN(a, z.set, "zoom-out");
                F.push(z.set);
                p -= g;
                u = Math.log(u / 100) / Math.log(v);
                c.realStepSize = p / (u - Math.log(B / 100) / Math.log(v));
                c.realGridHeight = p;
                c.stepMax = u
            }
            h && (h = b.set(), d.setCN(a, h, "zoom-control-pan"), e.push(h), F && F.translate(f, 4 * f), v = new d.SimpleButton, C ? v.svgIcon = d.line(b, [y / 5, -y + y / 5,
                y / 5
            ], [-y, 0, y], w, x, 1) : v.setIcon(a.pathToImages + "panLeft.gif", c.iconSize), v.setClickHandler(a.moveLeft, a), v.init(b, f, f, k, l, m, n, q, r, t, x, w, A), v.set.translate(0, f), d.setCN(a, v.set, "pan-left"), h.push(v.set), v = new d.SimpleButton, C ? v.svgIcon = d.line(b, [-y / 5, y - y / 5, -y / 5], [-y, 0, y], w, x, 1) : v.setIcon(a.pathToImages + "panRight.gif", c.iconSize), v.setClickHandler(a.moveRight, a), v.init(b, f, f, k, l, m, n, q, r, t, x, w, A), v.set.translate(2 * f, f), d.setCN(a, v.set, "pan-right"), h.push(v.set), v = new d.SimpleButton, C ? v.svgIcon = d.line(b, [-y, 0, y], [y / 5, -y + y / 5, y / 5], w, x, 1) : v.setIcon(a.pathToImages + "panUp.gif", c.iconSize), v.setClickHandler(a.moveUp, a), v.init(b, f, f, k, l, m, n, q, r, t, x, w, A), v.set.translate(f, 0), d.setCN(a, v.set, "pan-up"), h.push(v.set), v = new d.SimpleButton, C ? v.svgIcon = d.line(b, [-y, 0, y], [-y / 5, y - y / 5, -y / 5], w, x, 1) : v.setIcon(a.pathToImages + "panDown.gif", c.iconSize), v.setClickHandler(a.moveDown, a), v.init(b, f, f, k, l, m, n, q, r, t, x, w, A), v.set.translate(f, 2 * f), d.setCN(a, v.set, "pan-down"), h.push(v.set), e.push(h));
            c.homeButtonEnabled && (h = new d.SimpleButton,
                C ? h.svgIcon = d.polygon(b, [-y, 0, y, y - 1, y - 1, 2, 2, -2, -2, -y + 1, -y + 1], [0, -y, 0, 0, y - 1, y - 1, 2, 2, y - 1, y - 1, 0], w, x, 1, w, x) : h.setIcon(a.pathToImages + c.homeIconFile, c.iconSize), h.setClickHandler(a.goHome, a), c.panControlEnabled && (q = l = 0), h.init(b, f, f, k, l, m, n, q, r, t, x, w, A), c.panControlEnabled ? h.set.translate(f, f) : F && F.translate(0, 1.5 * f), d.setCN(a, h.set, "pan-home"), e.push(h.set));
            c.update()
        },
...
(function() {
    ...
    d.SimpleButton = d.Class({
        construct: function() {},
        init: function(a, b, c, e, f, g, h, k, l, m, n, q, r) {
            var t = this;
            t.rollOverColor = m;
            t.color = e;
            t.container = a;
            ...
            f = t.iconPath;
            var p;
            f && (p = t.iconSize, g = (b - p) / 2, r && (g = (2 * b - p) / 2), p = a.image(f, g, (c - p) / 2, p, p));
        ...
        init: function(a, b) {
            ...
            if (c.enabled) {
                ...
                isNaN(c.top) || (l = a.getY(c.top) +
                    g, p = 0);
                isNaN(c.bottom) || (l = a.getY(c.bottom, !0) - c.height - g, p = c.height - k + g / 2);
...
(function() {
    ...
    d.AreasProcessor = d.Class({
        ...
        updateAllAreas: function() {
            ...
            for (n = 0; n < h.length; n++) {
                ...
                if (b.preserveOriginalAttributes) {
                    if (l.customAttr)
                        for (var q in l.customAttr) l.setAttr(q,
                            l.customAttr[q])
                } else {
                ...
                k.getAreasFromMap && !m[l.id] && (r = new d.MapArea(a.theme), r.parentObject = k, r.id = l.id, k.areas.push(r))
            }
        },
        createArea: function(a) {
            ...
            m = a.balloonText;
            void 0 === m && (m = p);
            void 0 == e.colorSolid || isNaN(a.value) || (p = Math.floor((a.value - this.minValue) / ((this.maxValue - this.minValue) / b.colorSteps)), p == b.colorSteps && p--, p *= 1 / (b.colorSteps - 1), this.maxValue == this.minValue && (p = 1), a.colorReal = d.getColorFade(f, e.colorSolid, p));
            ...
            if (c && (q = c.area, x = c.title, a.enTitle = c.title, x && !a.title && (a.title = x), (c = b.language) ? (x = d.mapTranslations) && (c = x[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, q)) {
                c = a.tabIndex;
                void 0 === c && (c = e.tabIndex);
                void 0 !== c &&
                    q.setAttr("tabindex", c);
                a.displayObject = q;
                ...
                a.preserveOriginalAttributes ||
                    (q.setAttr("fill", C), q.setAttr("stroke", g), q.setAttr("stroke-opacity", r), q.setAttr("stroke-width", t), q.setAttr("fill-opacity", A));
...
(function() {
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function(a, b) {
            ...
            u = a.rollOverBrightness;
            void 0 == u && (u = F);
            void 0 == a.selectable && (a.selectable = x);
            a.colorReal = G;
            ...
            a.rollOverBrightnessReal = u;
            a.accessibleLabel ||
                (a.accessibleLabel = h.accessibleLabel);
            ...
            if (n) {
                ...
                p = F = 0;
                a.centeredReal ? (isNaN(a.right) || (F = C * x), isNaN(a.bottom) || (p = E * x)) : (F = C * x / 2, p = E * x / 2);
                D.translate(F, p, x, !0)
            } else u ? (isNaN(C) && (C = 10), isNaN(E) && (E = 10), D = e.image(u, 0, 0, C, E), D.node.setAttribute("preserveAspectRatio", "none"), D.setAttr("opacity", k), a.centeredReal && (F = isNaN(a.right) ? -C / 2 : C / 2, p = isNaN(a.bottom) ? -E / 2 : E / 2, D.translate(F, p, NaN, !0))) : B && (D = e.path(B), u = D.getBBox(), a.centeredReal ? (F = -u.x * x - u.width * x / 2, isNaN(a.right) || (F = -F), p = -u.y * x - u.height * x / 2, isNaN(a.bottom) || (p = -p)) : F = p = 0, D.translate(F, p, x, !0), D.x = F, D.y = p);
            ...
            G = a.labelColorReal;
            !a.showAsSelected && c.selectedObject != a || void 0 == h || (D.setAttr("fill",
        ...
        updateSizeAndPosition: function(a) {
            ...
            a.line && a.line.getCoordinates && (a.line.chart = b, p = a.line.getCoordinates(m, a.lineSegment)) && (k = b.coordinateToLongitude(p.x), l = b.coordinateToLatitude(p.y), r = p.x, t = p.y, a.animateAngle && (g = d.radiansToDegrees(p.angle)));
            isNaN(g) || c.rotate(g + a.extraAngle);
            isNaN(e) || isNaN(f) ? isNaN(l) || isNaN(k) || (f = b.coordinatesToXY(k, l), e = f.x, f = f.y, isNaN(r) || (e = r), isNaN(t) || (f = t), a.fixedSize ? (r = a.positionScale, isNaN(r) ? r = 0 : (--r,
                r *= 1 - 2 * Math.abs(m - .5)), m = {
                image: c,
                scale: 1 + r,
                mapImage: a
                ...
                arr: h,
                el: m
            }), c.translate(e, f, 1 / q + r, !0)) : (c.translate(e, f, NaN, !0), n && (this.labelsToReposition.push(a), a.arrays.push({
    ...
    d.LinesProcessor = d.Class({
        ...
        createLine: function(a, b) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                a.colorReal = l;
                a.arrowColor = m;
                isNaN(e.selectedBrightness) || (v = d.adjustLuminosity(a.colorReal, e.selectedBrightness / 100));
                a.alphaReal = t;
                a.rollOverColorReal = u;
                a.rollOverAlphaReal = p;
                a.balloonTextReal = B;
                a.selectedColorReal = v;
                a.thicknessReal = F;
                ...
                p = n.length;
                if (0 < p)
                    for (w = [], C = [], u = 0; u < p; u++) B = c.coordinatesToXY(n[u], e[u]), w.push(B.x), C.push(B.y);
                if (0 < w.length) {
                    a.segments = w.length;
                    d.dx = 0;
                    d.dy = 0;
                    var E, H, G, p = 10 * (1 - Math.abs(x));
                    10 <= p && (p = NaN);
                    1 > p && (p = 1);
                    a.arcRadius = [];
                    a.distances = [];
                    ...
                    if (isNaN(p)) {
                        for (p = 0; p < w.length - 1; p++) H =
                            Math.sqrt(Math.pow(w[p + 1] - w[p], 2) + Math.pow(C[p + 1] - C[p], 2)), a.distances[p] = H;
                        p = d.line(y, w, C, l, 1, F / n, k, !1, !1, !0);
                        l = d.line(y, w, C, l, .001, 5 / n, k, !1, !1, !0);
                    ...
                    if ("none" != A) {
                        var I, M, N;
                        if ("end" == A || "both" == A) u = w[w.length - 1], D = C[C.length - 1], 1 < w.length ?
                            (B = w[w.length - 2], I = C[C.length - 2]) : (B = u, I = D), I = 180 * Math.atan((D - I) / (u - B)) / Math.PI, isNaN(E) || (I += E), M = u, N = D, I = 0 > u - B ? I - 90 : I + 90;
                        t = [-r / 2 - .5, -.5, r / 2 - .5];
                        k = [r, -.5, r];
                        a.shiftArrow && "middle" != A && (k = [0, 1.2 * -r, 0]);
                        "both" == A && (r = d.polygon(y, t, k, m, q, 1, m, q, void 0, !0), z.push(r), r.translate(M, N, 1 / n, !0), isNaN(I) || r.rotate(I), d.setCN(c, p, "map-line-arrow"), void 0 != a.id && d.setCN(c, p, "map-line-arrow-" + a.id), a.fixedSize && f.push(r));
                        if ("start" == A || "both" == A) r = w[0], N = C[0], 1 < w.length ? (u = w[1], M = C[1]) : (u = r, M = N), I = 180 * Math.atan((N -
                            M) / (r - u)) / Math.PI, isNaN(E) || (I -= E), M = r, I = 0 > r - u ? I - 90 : I + 90;
                        "middle" == A && (u = w[w.length - 1], D = C[C.length - 1], 1 < w.length ? (B = w[w.length - 2], I = C[C.length - 2]) : (B = u, I = D), M = B + (u - B) / 2, N = I + (D - I) / 2, I = 180 * Math.atan((D - I) / (u - B)) / Math.PI, isNaN(E) || (E = H / 2, G -= Math.sqrt(G * G - E * E), 0 > x && (G = -G), E = Math.sin(I / 180 * Math.PI), -1 == E && (E = 1), M -= E * G, N += Math.cos(I / 180 * Math.PI) * G), I = 0 > u - B ? I - 90 : I + 90);
                        r = d.polygon(y, t, k, m, q, 1, m, q, void 0, !0);
                    ...
                    a.lineSvg = p;
                    a.showAsSelected && !isNaN(v) && p.setAttr("stroke", v);
        ...
        getCoordinates: function(a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (!isNaN(this.arc) && 0 !== this.arc && this.arcRadius) {
                    ...
                    var q = e + (g - e) / 2 + Math.sqrt(k * k - l / 2 * (l / 2)) * (f - c) / l;
                    c = 180 * Math.atan2(e - q, c - h) / Math.PI;
                    f = 180 * Math.atan2(g - q, f - h) / Math.PI;
                    180 < f - c && (f -= 360);
...
(function() {
    ...
    d.MapImage = d.Class({
        ...
        update: function() {
            var a = this;
            a.updatePosition();
            var b = Math.round(1E3 / d.updateRate),
...
(function() {
    ...
    d.normalizePath = function(a) {
        for (var b = "", c = d.parsePath(a.getAttribute("d")), e, f, g = Infinity, h = -Infinity, k = Infinity, l = -Infinity, m = 0; m < c.length; m++) {
            ...
            "v" == q && (q = "L", r = e, n += f);
            "V" == q && (q = "L", r = e);
            if ("m" === q || "l" === q) q = q.toUpperCase(), r += e, n += f;
            r = d.roundTo(r, 3);
            n = d.roundTo(n, 3);
            e = r;
            f = n;
    ...
    d.winkel3.invert = function(a, b) {
        ...
        do var h = Math.cos(e),
            ...
            p = t * t,
            v = 1 - n * r * r,
            B = v ? d.acos(h * r) * Math.sqrt(u = 1 / v) : u = 0,
            u, v = .5 * (2 * B * h * t + c / g) - a,
            x = .5 * (B * k + e) - b,
            w = .5 * u * (n * p + B * h * r * m) + .5 / g,
            A = u * (q * l / 4 - B * k * t),
            k = .125 * u * (l * t - B * k * n * q),
            m = .5 * u * (m * r + B * p * h) + .5,
            h = A * k - m * w,
            ...
            v = (v * k - x * w) / h,
            c = c - A,
            e = e - v; while ((1E-6 < Math.abs(A) || 1E-6 < Math.abs(v)) && 0 < --f);
        return [c, e]
    };
